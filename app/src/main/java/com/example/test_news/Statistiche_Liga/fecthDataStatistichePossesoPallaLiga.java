...
import com.example.test_news.Statistiche_SerieA.StatistichePossesoPallaSerieA;
...
public class fecthDataStatistichePossesoPallaLiga extends AsyncTask<Void,Void,Void> {
    ...
    protected Void doInBackground(Void... voids) {
        ...
        try {
            URL url = new URL("https://api.myjson.com/bins/zcwl4");
    ...
    protected void onPostExecute(Void aVoid) {
        ...
        StatistichePossesoPallaLiga.data.setText(this.dataParsed);
    }
}
