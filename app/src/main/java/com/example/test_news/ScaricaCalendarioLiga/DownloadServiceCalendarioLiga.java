...
public class DownloadServiceCalendarioLiga extends IntentService {
    ...
    public DownloadServiceCalendarioLiga() {
    ...
    private void downloadFile(String urlStr){
        ...
        try {
            ...
            Intent backIntent=new Intent(DownloadServiceCalendarioLiga.ACTION_DOWNLOAD);
            backIntent.putExtra(DownloadServiceCalendarioLiga.EXTRA_MESSAGE, message);
