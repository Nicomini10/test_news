...
public class fecthDataStatistichePossesoPallaLigue1 extends AsyncTask<Void,Void,Void> {
    ...
    protected Void doInBackground(Void... voids) {
        ...
        try {
            URL url = new URL("https://api.myjson.com/bins/h7iac");
    ...
    protected void onPostExecute(Void aVoid) {
        ...
        StatistichePossesoPallaLigue1.data.setText(this.dataParsed);
    }
}
