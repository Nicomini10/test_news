...
public class fecthDataStatisticheQuotePremier extends AsyncTask<Void,Void,Void> {
    ...
    protected Void doInBackground(Void... voids) {
        ...
        try {
            URL url = new URL("https://api.myjson.com/bins/w9g8o");
    ...
    protected void onPostExecute(Void aVoid) {
        ...
        StatisticheQuotePremier.data.setText(this.dataParsed);
    }
