...
public class fecthDataStatistichePossessoPremier extends AsyncTask<Void,Void,Void> {
    ...
    protected Void doInBackground(Void... voids) {
        ...
        try {
            URL url = new URL("https://api.myjson.com/bins/b1k8o");
    ...
    protected void onPostExecute(Void aVoid) {
        ...
        StatistichePossesoPremier.data.setText(this.dataParsed);
    }
}
