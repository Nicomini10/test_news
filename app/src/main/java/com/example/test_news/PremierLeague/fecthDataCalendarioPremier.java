...
public class fecthDataCalendarioPremier extends AsyncTask<Void,Void,Void>  {
    ...
    protected Void doInBackground(Void... voids) {
        ...
        try {
            URL url = new URL("https://allsportsapi.com/api/football/?met=Fixtures&leagueId=148&APIkey=d50e947c89b5f6faf60f34de2638da1d7fa9b92762c9c767ba5d464757a3d879&from=2019-08-09&to=2020-05-17");
