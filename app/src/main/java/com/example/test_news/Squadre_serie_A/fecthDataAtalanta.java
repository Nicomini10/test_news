...
public class fecthDataAtalanta extends AsyncTask<Void,Void,Void> {
    ...
    protected Void doInBackground(Void... voids) {
        ...
        try {
            URL url = new URL("https://allsportsapi.com/api/football/?&met=Teams&teamId=4181&APIkey=e4b18df2ce6d7f265da71fd7156ae4ce02d1d509ecedf0ed294fd75bfc526728");
    ...
    protected void onPostExecute(Void aVoid) {
        ...
        Atalanta.data.setText(this.dataParsed);
    }
}
